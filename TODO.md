...
- [ ] Admin panel (users, problems, submissions)
- [ ] Registration
...
- [ ] User profile page
- [ ] Problem tags and search
- [ ] Clarifications / questions in contests
- [ ] Download own submissions
- [ ] Code highlight
- [ ] Docker / Config file (port, data dir)

## Optional

- [ ] OIOIOI problem package import
- [ ] API tokens (for `sio-cli`)
